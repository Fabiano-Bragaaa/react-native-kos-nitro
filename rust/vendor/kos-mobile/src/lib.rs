...
#[uniffi::export]
pub fn get_path_by_chain(chain_id: u32, index: u32, use_legacy_path: bool) -> Result<String, KOSError> {
...
#[uniffi::export]
pub fn encrypt_with_gcm(data: String, password: String, iterations: u32) -> Result<String, KOSError> {
    let encrypted_data = CipherAlgo::GCM.encrypt(data.as_bytes(), password.as_str(), iterations)?;
    Ok(encrypted_data.encode_hex())
}

#[uniffi::export]
pub fn encrypt_with_cbc(data: String, password: String, iterations: u32) -> Result<String, KOSError> {
    let encrypted_data = CipherAlgo::CBC.encrypt(data.as_bytes(), password.as_str(), iterations)?;
    Ok(encrypted_data.encode_hex())
}

#[uniffi::export]
pub fn encrypt_with_cfb(data: String, password: String, iterations: u32) -> Result<String, KOSError> {
